...
describe('Link generation in preview', () => {
  ...
  it('generates a link to a note', () => {
    expect(md.render(`[[note-a]]`)).toEqual(
      `<p><a class='loam-note-link' title='${noteA.title}' href='/path/to/note-a.md' data-href='/path/to/note-a.md'>note-a</a></p>\n`
    );
  });
  ...
  it('generates a wikilink even when there is a link reference', () => {
    ...
    expect(md.render(note)).toEqual(
      `<p><a class='loam-note-link' title='${noteA.title}' href='/path/to/note-a.md' data-href='/path/to/note-a.md'>note-a</a>\n[note-a]: &lt;note-a.md&gt; &quot;Note A&quot;</p>\n`
    );
  });
  ...
  it('generates a link to a note with a specific section', () => {
    expect(md.render(`[[note-b#sec2]]`)).toEqual(
      `<p><a class='loam-note-link' title='My second note#sec2' href='/path2/to/note-b.md#sec2' data-href='/path2/to/note-b.md#sec2'>note-b#sec2</a></p>\n`
    );
  });
  ...
  it('generates a link to a note if the note exists, but the section does not exist', () => {
    expect(md.render(`[[note-b#nonexistentsec]]`)).toEqual(
      `<p><a class='loam-note-link' title='My second note#nonexistentsec' href='/path2/to/note-b.md#nonexistentsec' data-href='/path2/to/note-b.md#nonexistentsec'>note-b#nonexistentsec</a></p>\n`
    );
  });
